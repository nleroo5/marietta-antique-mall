    ...
    <footer className="bg-secondary text-white">
      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Hours Section */}
          <div>
            <h4 className="font-display text-lg font-bold mb-4 text-accent">Hours</h4>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-lg font-bold mb-4 text-accent">Quick Links</h4>
            <ul className="space-y-2 text-gray-300">
              <li>
              ...
              <li>
                <Link href="/vendors" className="hover:text-accent transition-colors">
                  Our Vendors
                </Link>
              </li>
              <li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-display text-lg font-bold mb-4 text-accent">Visit Us</h4>
            ...
            <p className="mt-4 text-sm text-gray-400">
              Near the famous Big Chicken landmark
            </p>
          </div>
        </div>
      </div>
